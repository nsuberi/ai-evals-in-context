...
QUESTIONS = [
    # Return policy questions (1-5)
    {
        ...
        "v2_hallucinations": [
            {"text": "The shipping fee is stated as $9.99, but the actual fee is $8.95.", "span_text": "$9.99 shipping fee"},
            {"text": "Refund processing time is stated as 3-5 days, but it's actually 5-7 business days.", "span_text": "3-5 business days"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 30-day return window from the knowledge base.", "span_text": "30-day return window from delivery date"},
            {"text": "Correctly states $8.95 shipping fee matching knowledge base.", "span_text": "$8.95 flat shipping fee"},
            {"text": "Correctly states 5-7 business days refund processing time.", "span_text": "5-7 business days"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Warranty period stated as 60 days, but actual warranty is 90 days.", "span_text": "60 days"},
            {"text": "Processing time stated as 2-3 business days, actual refund processing is 5-7 business days.", "span_text": "2-3 business days"},
            {"text": "Receipt requirement is fabricated; actual policy requires an RMA number from support.", "span_text": "original receipt"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 90-day warranty period.", "span_text": "90-day warranty"},
            {"text": "Correctly states free replacement or full refund options.", "span_text": "free replacement or a full refund"},
            {"text": "Correctly states RMA number requirement.", "span_text": "RMA number"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "The 14-day opening period and 15% restocking fee are fabricated; no such policy exists.", "span_text": "opened more than 14 days ago may be subject to a restocking fee of 15%"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly lists all three non-returnable categories.", "span_text": "customized or personalized widgets, clearance items marked \"Final Sale,\" and items damaged due to customer misuse"},
            {"text": "Correctly states 30-day return window.", "span_text": "30-day return window"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Refund timeline stated as 3-5 days, but actual is 5-7 business days.", "span_text": "3-5 business days"},
            {"text": "Store credit bonus stated as 5%, but actual bonus is 10%.", "span_text": "5% bonus"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 5-7 business days processing time.", "span_text": "5-7 business days"},
            {"text": "Correctly states 10% store credit bonus.", "span_text": "10% bonus value"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Store credit bonus stated as 15%, but actual bonus is 10%.", "span_text": "15% bonus"},
            {"text": "The $115 example is wrong; it should be $110 (10% of $100 = $10 bonus).", "span_text": "$115 in store credit"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 10% bonus value for store credit.", "span_text": "10% bonus value"},
            {"text": "Correctly states 5-7 business days processing.", "span_text": "5-7 business days"},
        ],
    },
    # Pricing questions (6-10)
    {
        ...
        "v2_hallucinations": [
            {"text": "Price stated as $59/month, but actual price is $49/month.", "span_text": "$59 per month"},
            {"text": "Response time stated as 24-hour, but Starter plan has 48-hour response.", "span_text": "24-hour response time"},
            {"text": "User seats stated as 2, but Starter plan has 1 user seat.", "span_text": "2 user seats"},
            {"text": "Annual discount stated as 10%, but actual is 20%.", "span_text": "10% with annual billing"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states 48-hour response time.", "span_text": "48-hour response time"},
    ...
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Price stated as $349/month, but actual price is $299/month.", "span_text": "$349 per month"},
            {"text": "Response time stated as 2-hour, but actual is 4-hour response time.", "span_text": "2-hour response time"},
            {"text": "Annual discount stated as 15%, but actual discount is 20%.", "span_text": "15% discount"},
            {"text": "Uptime stated as 99.95%, but actual SLA is 99.9%.", "span_text": "99.95% uptime guarantee"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states $299/month price from knowledge base.", "span_text": "$299 per month"},
            {"text": "Correctly states 4-hour response time.", "span_text": "4-hour response time"},
            {"text": "Correctly states 99.9% uptime SLA.", "span_text": "99.9% uptime SLA guarantee"},
            {"text": "Correctly states 20% annual discount.", "span_text": "20% with annual billing"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Price stated as $179/month, but actual is $149/month.", "span_text": "$179 per month"},
            {"text": "Response time stated as 12-hour, but actual is 24-hour for Professional.", "span_text": "12-hour response time"},
            {"text": "User seats stated as 3, but actual is 5 user seats.", "span_text": "3 user seats"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states 24-hour response time.", "span_text": "24-hour response time"},
    ...
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Enterprise price stated as $349/month, but actual is $299/month.", "span_text": "$349/month with unlimited"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states all three plan prices.", "span_text": "Starter ($49/month)"},
            {"text": "Correctly states Enterprise at $299/month.", "span_text": "Enterprise ($299/month)"},
            {"text": "Correctly states 14-day trial and 20% annual savings.", "span_text": "14-day trial; annual billing saves 20%"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Trial period stated as 7 days, but actual trial is 14 days.", "span_text": "7-day free trial"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 14-day free trial.", "span_text": "14-day free trial"},
            {"text": "Correctly states 20% annual savings.", "span_text": "20% with annual billing"},
        ],
    },
    # Product specs questions (11-15)
    {
        ...
        "v2_hallucinations": [
            {"text": "Dimensions wrong: stated 4.5-inch but X2 is 5\" x 5\" x 2.5\".", "span_text": "4.5-inch display"},
            {"text": "Weight wrong: stated 10 oz but actual weight is 12 oz.", "span_text": "10 oz"},
            {"text": "Material wrong: stated aluminum alloy but actual is carbon fiber composite.", "span_text": "aluminum alloy"},
            {"text": "Battery wrong: stated 3000mAh/10 hours but actual is 3500mAh/12 hours.", "span_text": "3000mAh battery providing 10 hours"},
            {"text": "Water resistance wrong: stated IP65 but actual is IP67.", "span_text": "IP65 water resistance"},
            {"text": "Price wrong: stated $149.99 but actual price is $129.99.", "span_text": "$149.99"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states carbon fiber composite material.", "span_text": "carbon fiber composite"},
            {"text": "Correctly states battery specs.", "span_text": "3500mAh lithium-ion battery provides 12 hours"},
    ...
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Price stated as $89.99, but actual is $79.99.", "span_text": "$89.99"},
            {"text": "Battery stated as 2500mAh/10 hours, but actual is 2000mAh/8 hours.", "span_text": "2500mAh battery for 10 hours"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states 2000mAh battery with 8-hour life.", "span_text": "2000mAh lithium-ion battery with 8-hour life"},
            {"text": "Correctly states aircraft-grade aluminum.", "span_text": "aircraft-grade aluminum"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Price stated as $299.99, but actual is $249.99.", "span_text": "$299.99"},
            {"text": "Weight stated as 16 oz, but actual is 18 oz.", "span_text": "16 oz"},
            {"text": "Material stated as stainless steel, but actual is industrial steel housing.", "span_text": "stainless steel housing"},
            {"text": "Temperature range stated as -10C to 50C, but actual is -20C to 60C.", "span_text": "-10C to 50C"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states $249.99 with bulk discounts.", "span_text": "$249.99 (bulk discounts available)"},
            {"text": "Correctly states 18 oz weight.", "span_text": "18 oz"},
            {"text": "Correctly states -20C to 60C operating range.", "span_text": "-20C to 60C"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "X2 price stated as $139.99, but actual is $129.99.", "span_text": "$139.99"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly compares battery specs.", "span_text": "3500mAh/12hr battery"},
            {"text": "Correctly identifies X2 additions.", "span_text": "NFC and IP67 water resistance"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Water resistance stated as IP65, but actual rating is IP67.", "span_text": "IP65 water resistance rating"},
            {"text": "IP65 description is wrong; IP67 allows submersion up to 1m for 30 min.", "span_text": "protected against low-pressure water jets"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states IP67 rating.", "span_text": "IP67 water resistance rating"},
            {"text": "Correctly states $129.99 price.", "span_text": "$129.99"},
        ],
    },
    # Shipping questions (16-20)
    {
        ...
        "v2_hallucinations": [
            {"text": "Standard delivery stated as 7-10 days, actual is 5-7 business days.", "span_text": "7-10 days"},
            {"text": "Standard cost stated as $4.95, actual is $5.95.", "span_text": "$4.95"},
            {"text": "Free threshold stated as $75, actual is $50.", "span_text": "free over $75"},
            {"text": "Overnight cutoff stated as 3 PM, actual is 2 PM EST.", "span_text": "3 PM EST"},
            {"text": "Overnight price stated as $29.95, actual is $24.95.", "span_text": "$29.95"},
            {"text": "International to 30+ countries, actual is 50+.", "span_text": "30+ countries"},
            {"text": "Signature threshold stated as $150, actual is $200.", "span_text": "over $150"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states standard shipping details.", "span_text": "Standard (5-7 days, $5.95, free over $50)"},
            {"text": "Correctly states express shipping.", "span_text": "Express (2-3 days, $12.95)"},
            {"text": "Correctly states overnight shipping.", "span_text": "Overnight (next business day, $24.95, order by 2 PM EST)"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Express price stated as $14.95, actual is $12.95.", "span_text": "$14.95"},
            {"text": "Express delivery stated as 1-2 days, actual is 2-3 business days.", "span_text": "1-2 business days"},
            {"text": "Same-day cutoff stated as 3 PM, actual is 2 PM EST.", "span_text": "3 PM EST"},
            {"text": "Tracking stated as 48 hours, actual is within 24 hours.", "span_text": "48 hours"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states 2-3 business days.", "span_text": "2-3 business days"},
    ...
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Country count stated as 40+, actual is 50+.", "span_text": "40 countries"},
            {"text": "Delivery stated as 10-21 days, actual is 7-14 business days.", "span_text": "10-21 business days"},
            {"text": "Customs stated as included, but actual policy says buyer's responsibility.", "span_text": "included in the shipping price"},
            {"text": "Free expedited shipping claim is fabricated; no such policy exists.", "span_text": "free expedited shipping"},
        ],
        ...
        "v3_accuracies": [
            ...
            {"text": "Correctly states 7-14 business days.", "span_text": "7-14 business days"},
            {"text": "Correctly states customs are buyer's responsibility.", "span_text": "customs duties and import taxes are the buyer's responsibility"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Free shipping threshold stated as $75, actual is $50.", "span_text": "over $75"},
            {"text": "Repeated wrong threshold: under $75 should be under $50.", "span_text": "under $75"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states free shipping threshold of $50.", "span_text": "free on domestic orders over $50"},
            {"text": "Correctly states $5.95 standard shipping cost.", "span_text": "$5.95"},
        ],
    },
    {
        ...
        "v2_hallucinations": [
            {"text": "Cutoff stated as 3 PM EST, actual is 2 PM EST.", "span_text": "3 PM EST"},
            {"text": "Tracking email stated as within 48 hours, actual is within 24 hours.", "span_text": "48 hours"},
            {"text": "Signature threshold stated as $100, actual is $200.", "span_text": "over $100"},
        ],
        ...
        "v3_accuracies": [
            {"text": "Correctly states 2 PM EST cutoff.", "span_text": "2 PM EST"},
            {"text": "Correctly states tracking within 24 hours.", "span_text": "within 24 hours"},
            {"text": "Correctly states $200 signature threshold.", "span_text": "over $200"},
        ],
    },
]
...
def build_v3_trace(idx, q):
    ...
    return {
        ...
        "prompt": prompt,
        "response": response,
        "latency_ms": random.randint(1500, 2000),
        "tokens": {"prompt": len(prompt.split()) + random.randint(350, 450), "completion": word_count + random.randint(-3, 5)},
